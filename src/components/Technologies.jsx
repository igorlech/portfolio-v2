export default function Technologies() {
  return (
    <div className="skills-technologies">
      <div className="single-technology">HTML</div>
      <div className="single-technology">CSS/SCSS</div>
      <div className="single-technology">JavaScript</div>
      <div className="single-technology">TypeScript</div>
      <div className="single-technology">React</div>
